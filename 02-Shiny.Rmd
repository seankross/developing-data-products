...
```{r, cache=FALSE, echo=FALSE}
knitr::read_chunk("assets/shinyapps/app3/ui.R")
```

```{r app3-ui, eval=FALSE}
```

**App 3: server.R**

```{r, cache=FALSE, echo=FALSE}
knitr::read_chunk("assets/shinyapps/app3/server.R")
```

```{r app3-server, eval=FALSE}
```

The code above will produce an app that looks like this:

```{r, echo=FALSE}
check_app_image("app3", 300)
```
...
```{r, cache=FALSE, echo=FALSE}
knitr::read_chunk("assets/shinyapps/app4/ui.R")
```

```{r app4-ui, eval=FALSE}
```

**App 4: server.R**

```{r, cache=FALSE, echo=FALSE}
knitr::read_chunk("assets/shinyapps/app4/server.R")
```

```{r app4-server, eval=FALSE}
```

The code above will produce an app that looks like this:

```{r, echo=FALSE}
check_app_image("app4", 300)
```
...
```{r, cache=FALSE, echo=FALSE}
knitr::read_chunk("assets/shinyapps/app5/ui.R")
```

```{r app5-ui, eval=FALSE}
```

**App 5: server.R**

```{r, cache=FALSE, echo=FALSE}
knitr::read_chunk("assets/shinyapps/app5/server.R")
```

```{r app5-server, eval=FALSE}
```

The code above will produce an app that looks like this:

```{r, echo=FALSE}
check_app_image("app5", 300)
```
...
```{r, cache=FALSE, echo=FALSE}
knitr::read_chunk("assets/shinyapps/app6/ui.R")
```

```{r app6-ui, eval=FALSE}
```

**App 6: server.R**

```{r, cache=FALSE, echo=FALSE}
knitr::read_chunk("assets/shinyapps/app6/server.R")
```

```{r app6-server, eval=FALSE}
```

The code above will produce an app that looks like this:

```{r, echo=FALSE}
check_app_image("app6", 300)
```
...
```{r, cache=FALSE, echo=FALSE}
knitr::read_chunk("assets/shinyapps/app7/ui.R")
```

```{r app7-ui, eval=FALSE}
```

The code above will produce an app that looks like this:

```{r, echo=FALSE}
check_app_image("app7", 300)
```
...
```{r, cache=FALSE, echo=FALSE}
knitr::read_chunk("assets/shinyapps/app8/ui.R")
```

```{r app8-ui, eval=FALSE}
```

**App 8: server.R**

```{r, cache=FALSE, echo=FALSE}
knitr::read_chunk("assets/shinyapps/app8/server.R")
```

```{r app8-server, eval=FALSE}
```

The code above will produce an app that looks like this:

```{r, echo=FALSE}
check_app_image("app8", 300)
```
