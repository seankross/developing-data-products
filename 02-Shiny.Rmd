...
```{r, echo=FALSE}
library(webshot)
appshot(app = "assets/shinyapps/app1/", file = file.path("assets", "images", "app1.png"),
        vheight = 300)
```
...
All Shiny is doing is piecing together some HTML! Let's take a look at another
simple app with a slighly more complex UI:
